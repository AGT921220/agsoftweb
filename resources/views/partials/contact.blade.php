...
<section
  id="contact"
  class="contact-form py-5 text-center"
  data-aos="fade-up"
...
>
  <div class="container">
    ...
    <form action="/contact" method="POST" class="mt-4">
      ...
      <div
        class="d-grid gap-2 col-12 mx-auto"
        data-aos="fade-up"
        data-aos-delay="800"
      >
    ...
    <p class="mt-2">
      <small>Basados en San Nicolás, Nuevo León | Operamos de manera remota para ofrecerte flexibilidad y adaptabilidad en cada proyecto.</small>
    </p>
    <p class="mt-2">
      <small>Tu privacidad es importante para nosotros. Toda la información proporcionada será tratada con estricta confidencialidad.</small>
    </p>
