...
>
  <div class="container">
    ...
    <div class="row">
      ...
      {{--
      <div class="col-md-4 mb-4 d-flex align-items-center justify-content-center" data-aos="fade-right">
        <img
          src="https://images.unsplash.com/photo-1521790365209-f9a3a5a3c536"
          alt="Equipo AgSoftWeb"
          class="aboutus-img img-fluid rounded shadow"
        />
      </div>
      --}}
